...
const ServiceCard = ({ titleKey, descKey, icon: Icon, index }: ServiceCardProps) => {
    ...
    return (
        <motion.div
            ...
            className="relative h-full bg-slate-900/40 border border-slate-800 p-8 overflow-hidden group hover:border-brand-500/50 transition-colors duration-500"
        >
            {/* Tech Corners */}
            ...
            <div className="absolute top-0 right-0 w-2 h-2 border-t border-r border-slate-600 group-hover:border-cyan-400 transition-colors"></div>
            <div className="absolute bottom-0 left-0 w-2 h-2 border-b border-l border-slate-600 group-hover:border-cyan-400 transition-colors"></div>
            ...
            <div className="relative z-10 flex flex-col items-start h-full">
                <div className="mb-6 inline-flex p-3 rounded bg-slate-800/80 text-cyan-400 border border-slate-700 shadow-[0_0_10px_rgba(6,182,212,0.2)] group-hover:text-white group-hover:bg-brand-500 group-hover:border-brand-400 transition-all duration-300">
                    <Icon size={28} />
                </div>
                <h3 className="scanline-effect inline-block mb-4 text-xl font-mono font-bold text-white group-hover:text-cyan-200 transition-colors">{t(titleKey)}</h3>
                <p className="text-slate-400 leading-relaxed text-sm font-sans flex-grow">
                    {t(descKey)}
                </p>
            </div>
        </motion.div>
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <h2 className="scanline-effect inline-block font-display font-bold text-4xl md:text-5xl text-white mb-6">
                        {t('services.title')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-brand-500">{t('services.titleHighlight')}</span>
                    </h2>
